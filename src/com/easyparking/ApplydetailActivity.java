...
public class ApplydetailActivity extends BaseActivity {
	...
	private void initBtns(){
		...
		view_comment.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(ApplydetailActivity.this,CommentActivity.class);
				...
				showCfmMsg("警告", "您确定开始停车?",
						new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								}).execute("/apply_approved","POST","aid="+apply_id+"&uid="+uid);
							}
				}, CFM_CANCELCB);
				...
				showCfmMsg("警告", "您确定结束停车?",
						new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								}).execute("/apply_leave","POST","aid="+apply_id+"&uid="+uid);
							}
				}, CFM_CANCELCB);
		...
		add_comment.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(ApplydetailActivity.this,CommentaddActivity.class);
			...
			public void run(String res) {
				...
				try {
					...
					if ("success".equals(r.getString("code"))) {
						...
						JSONObject ownerinfo = spotinfo.getJSONObject("userinfo");
						address.setText(spotinfo.getString("address")+"("+spotinfo.getString("code")+")");
						period.setText(Helper.showDateTime(row.getString("start_time"))+" ~ "+Helper.showDateTime(row.getString("end_time")));
						...
						else if(state.equals("success") && !row.getBoolean("user_comment")){
