...
import com.easyparking.ChooseposActivity;
...
//		handler.sendMessage(Message.obtain(handler, HttpConnection.DID_START));
		...
		try {
			...
			switch (method) {
			case GET:
				httpResponse = httpClient.execute(new HttpGet(Config.Server_URL + url));
				...
				break;
			case POST:
				HttpPost httpPost = new HttpPost(Config.Server_URL + url);
